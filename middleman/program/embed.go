...
middleman <b><yellow>(B)</yellow></b> acts as an intermediary which forwards requests from client <b><yellow>(A)</yellow></b> to server <b><yellow>(C)</yellow></b> and returns the server's response to client <b><yellow>(A)</yellow></b>.
When <b>middleman</b> is run on your deployment environment <b><yellow>(B)</yellow></b> (and allowed to host on port 8080) you can make calls like:
...
<b>client <b><yellow>(A)</yellow></b> -> middleman <b><yellow>(B)</yellow></b> -> server <b><yellow>(C)</yellow></b></b>
